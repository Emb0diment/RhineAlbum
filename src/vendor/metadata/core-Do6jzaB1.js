...
const ContentType = /* @__PURE__ */ getDefaultExportFromCjs(distExports);
...
const mpegParserLoader = {
  ...
  async load() {
    return (await import("./MpegParser-9Gajeb6o.js")).MpegParser;
  }
};
...
const asfParserLoader = {
  ...
  async load() {
    return (await import("./AsfParser-BcfTaveX.js")).AsfParser;
  }
};
const dsdiffParserLoader = {
  ...
  async load() {
    return (await import("./DsdiffParser-Dt_uoPc_.js")).DsdiffParser;
  }
};
const aiffParserLoader = {
  ...
  async load() {
    return (await import("./AiffParser-gb8fshbk.js")).AIFFParser;
  }
};
const dsfParserLoader = {
  ...
  mimeTypes: ["audio/dsf"],
  async load() {
    return (await import("./DsfParser-BTyJdUps.js")).DsfParser;
  }
};
const flacParserLoader = {
  ...
  async load() {
    return (await import("./FlacParser-Bz_UfDdC.js").then((n) => n.d)).FlacParser;
  }
};
const matroskaParserLoader = {
  ...
  async load() {
    return (await import("./MatroskaParser-DQEizK4Y.js")).MatroskaParser;
  }
};
const mp4ParserLoader = {
  ...
  async load() {
    return (await import("./MP4Parser-CXXH-KGf.js")).MP4Parser;
  }
};
const musepackParserLoader = {
  ...
  async load() {
    return (await import("./MusepackParser-DB5t5Hdj.js")).MusepackParser;
  }
};
const oggParserLoader = {
  ...
  async load() {
    return (await import("./OggParser-BFMVlCfY.js")).OggParser;
  }
};
const wavpackParserLoader = {
  ...
  async load() {
    return (await import("./WavPackParser-DEgqv__U.js")).WavPackParser;
  }
};
const riffParserLoader = {
  ...
  async load() {
    return (await import("./WaveParser-CvvMsN94.js")).WaveParser;
  }
};
...
export {
  ...
  SyncTextHeader as W,
  ExtendedHeader as X,
  CouldNotDetermineFileTypeError as Y,
  InternalParserError as Z,
  LyricsContentType as _,
  UINT16_BE as a,
  UnexpectedFileContentError as a0,
  UnsupportedFileTypeError as a1,
  getSupportedMimeTypes as a2,
  makeParseError as a3,
  orderTags as a4,
  parseBlob as a5,
  parseBuffer as a6,
  parseFile as a7,
  parseFromTokenizer as a8,
  parseStream as a9,
  parseWebStream as aa,
  ratingToStars as ab,
  scanAppendingHeaders as ac,
  selectCover as ad,
  UINT8 as b,
  Uint8ArrayType as c,
  initDebug as d,
